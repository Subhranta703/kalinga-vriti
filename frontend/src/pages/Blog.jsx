...
export default function OdishaTechEcosystem() {
  ...
  return (
    <div className="min-h-screen bg-orange-50">
      {/* 🌟 Hero Section */}
      <div className="bg-gradient-to-br from-amber-100 to-orange-100 px-6 py-20 md:py-36">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-serif mb-2">
            <span className="text-gray-800 font-semibold">
              Stories from Odisha's{" "}
            </span>
            <span className="text-orange-500 font-semibold block md:inline">
              Tech Ecosystem
            </span>
          </h1>

          <p className="text-gray-500 my-6 md:my-10">
            Real founders. Real challenges. Real solutions.
          </p>
      ...
      {/* 🧭 Filter Buttons */}
      <div className="max-w-6xl mx-auto py-10 px-4 grid grid-cols-2 md:grid-cols-5 gap-4">
        <button className="bg-orange-500 text-white py-2 rounded-full text-sm flex items-center justify-center gap-2">
          <img src={rocket} className="h-5" /> Founder Journey
        </button>

        <button className="bg-gray-200 py-2 rounded-full text-sm flex items-center justify-center gap-2">
          <img src={tech} className="h-5" /> Tech & Innovation
        </button>

        <button className="bg-gray-200 py-2 rounded-full text-sm flex items-center justify-center gap-2">
          <img src={career} className="h-5" /> Career & Growth
        </button>

        <button className="bg-gray-200 py-2 rounded-full text-sm flex items-center justify-center gap-2">
          <img src={eco} className="h-5" /> Ecosystem Updates
        </button>

        <button className="bg-gray-200 py-2 rounded-full text-sm flex items-center justify-center gap-2">
          <img src={blackcal} className="h-5" /> Event Chronicles
        </button>
      </div>

      {/* 🌟 Featured Story */}
      <div className="max-w-6xl mx-auto px-4 md:px-10 lg:px-20 py-16 grid md:grid-cols-2 gap-8 items-center bg-gradient-to-br from-amber-100 to-orange-100 rounded-xl">
        {/* Left - Image */}
        <img src={human} alt="founder" className="rounded-lg shadow-md w-full" />
        ...
        <div className="bg-white rounded-xl p-6 shadow-md">
          ...
          <h1 className="font-extrabold text-gray-900 text-2xl md:text-3xl mb-3 font-serif">
            How I Built a ₹5 Cr Startup from Cuttack Without Moving to Bangalore
          </h1>
      ...
      {/* 📰 Blogs + Sidebar */}
      <div className="max-w-6xl mx-auto px-4 md:px-10 lg:px-20 py-16 grid lg:grid-cols-[3fr_1fr] gap-10">
        {/* Left - Blog Cards */}
          ...
          {blogs.map((blog, index) => (
            ...
            >
              ...
              <div className="py-4 px-6">
                ...
                <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-2 leading-tight font-serif">
                  {blog.title}
                </h3>
                <p className="text-gray-600 text-sm mb-4 leading-relaxed">
                  {blog.description}
