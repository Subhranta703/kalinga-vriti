...
export default function Header() {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
        ...
        {/* <div className="flex items-center gap-3 sm:gap-4">
          <div className="relative flex items-center h-12 w-auto">
            <img src={odisha} alt="Odisha Emblem" className="h-16 w-auto" />
            <div className="flex flex-col bg-red-900"> 
            <img
              src={logo}
              alt="KV Logo"
              className="absolute left-3 top-1 h-10 w-auto object-contain mix-blend-multiply"
            />
            <h1>Kalinga Vriti</h1>
          </div>
 ...
 <div className="flex items-center gap-3 sm:gap-4">
  <div className="relative flex items-center h-12 w-auto">
    <img src={odisha} alt="Odisha Emblem" className="h-[80px] w-auto" />

    <div className="flex flex-col bg-red-900">
      <img
        src={logo}
        alt="KV Logo"
        className="absolute left-4 -top-1 h-12 w-auto object-contain mix-blend-multiply"
      />

      {/* One-line text below logo */}
      <h1 className="absolute left-4 top-8 text-[8px] text-black whitespace-nowrap font-semibold">
        Kalinga Vriti
      </h1>
    </div>
  </div>
  ...
  <div className="flex flex-col leading-tight">
    <Link to="/" className="text-md  font-thin  text-gray-800 font-serif tracking-wider
    ">
      Kalinga Vriti
    </Link>
    <p className="text-[10px] text-gray-500 font-thin font-serif tracking-wider mt-1">
